...
namespace Alm\UserBundle\Controller;
...
class SecurityController extends Controller
{
    ...
    public function loginRenderAction(Request $request)
    {
        /** @var $session \Symfony\Component\HttpFoundation\Session\Session */
        $session = $request->getSession();
    ...
    {
        return $this->render('FOSUserBundle:Security:loginRender.html.twig', $data);
    }
